"""
Обучение улучшенной модели фортепиано v2.
Запуск: python src/train_guitar_piano_v2.py
"""
...
from data.midi_dataset_guitar_piano_v2 import GuitarPianoDatasetV2
from models.lstm_model import LSTMAccompanimentModel

DEVICE        = torch.device("cpu")
DATA_ROOT     = "data/lmd/lmd_matched"
CKPT_DIR      = "models/guitar_piano_v2_checkpoints"
FINAL_PATH    = "models/guitar_piano_final/model.pt"  # перезаписываем основную
...
def train():
    ...
    print("Загружаю датасет v2 (гитара → фортепиано, с квантизацией)...")
    train_ds = GuitarPianoDatasetV2(DATA_ROOT, split="train", max_files=5000)
    val_ds   = GuitarPianoDatasetV2(DATA_ROOT, split="val",   max_files=1000)
